...
_LEQ:
    ...
    BRA _EQ
    GOTO _HEAT ;IF MEAS<REF TURN ON PORTD,2
_EQ:
...
_NOTHING:
 ...
 GOTO _CONVERT
_COOL:
 MOVLW CONT_REG_COOL ;TURN ON COOLING SYSTEM AND PORTD,2 OFF
 MOVWF CONT_REG
 MOVFF CONT_REG, PORTD
 GOTO _CONVERT
_HEAT:
...
_CONVERT:
    ...
    MOVWF NUMERATOR
    CLRF SIGN_FLAG
    BTFSS NUMERATOR, 7 ;CHECK FOR ((STATUS) and 0FFh), 4, a
    GOTO _POSITIVE ; IF POSITIVE SKIP NEXT SECTION
    COMF NUMERATOR, F ;IF ((STATUS) and 0FFh), 4, a PERFORM 2'S COMPLEMENT 
    INCF NUMERATOR, F
...
_D1MEAS:
    ...
    SUBWF NUMERATOR,F
    BC _D1MEAS ;KEEP GOING TILL BELOW ((STATUS) and 0FFh), 2, a
    ...
    MOVFF COUNTER, NUMERATOR ;((SMT1CON1) and 0FFh), 6, b PROCESS WITH VALUE IN COUNTER
    CLRF COUNTER
_D2MEAS:
