...
static volatile uint8_t uart2TxBuffer[(128)];
volatile uint8_t uart2TxBufferRemaining;

static volatile uint8_t uart2RxHead = 0;
static volatile uint8_t uart2RxTail = 0;
static volatile uint8_t uart2RxBuffer[(128)];
static volatile uart2_status_t uart2RxStatusBuffer[(128)];
...
size_t UART2_ErrorGet(void)
{
    uart2RxLastError.status = uart2RxStatusBuffer[(uart2RxTail + 1) & ((128) - 1)].status;
...
uint8_t UART2_Read(void)
{
    ...
    tempRxTail = (uart2RxTail + 1) & ((128) - 1);
...
void UART2_ReceiveISR(void)
{
 ...
 uint8_t tempRxHead;
    ...
    tempRxHead = (uart2RxHead + 1) & ((128) - 1);
...
void UART2_Write(uint8_t txData)
{
    ...
    else if(uart2TxBufferRemaining)
    {
       ...
       tempTxHead = (uart2TxHead + 1) & ((128) - 1);
...
void UART2_TransmitISR(void)
{
    ...
    if(sizeof(uart2TxBuffer) > uart2TxBufferRemaining)
    {
       ...
       tempTxTail = (uart2TxTail + 1) & ((128) - 1);
